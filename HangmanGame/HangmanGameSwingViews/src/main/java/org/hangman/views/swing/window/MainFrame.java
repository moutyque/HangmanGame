package org.hangman.views.swing.window;
...
import org.hangman.views.swing.menu.AboutMenue;
import org.hangman.views.swing.menu.FilesMenu;
import org.hangman.views.swing.panel.AboutPanel;
import org.hangman.views.swing.panel.GamePanel;
import org.hangman.views.swing.panel.HomePanel;
import org.hangman.views.swing.panel.RulesPanel;
import org.hangman.views.swing.panel.ScoresPanel;
	...
	public void update(Observable o, Object arg) {
		if(Integer.class.isInstance(arg)) {
			...
			case UPDATE_END_ROUND:
				JOptionPane.showMessageDialog(this, "Vous avez gagné ce round, le motà trouver était : " + this.game.getCurrentRound().getWord());
				break;
